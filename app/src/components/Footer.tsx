        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-8">
          ...
          <div className="lg:col-span-1">
            <a href="/" className="inline-block mb-6">
              <span className="font-display text-3xl font-bold tracking-tight">MAAN</span>
              <span className="font-accent text-gold text-xl ml-1">Estate</span>
            </a>
            <p className="text-gray-400 text-sm mb-6 leading-relaxed">
              DHA & Dubai | Trustworthy Real Estate Team. Your trusted partner in DHA real estate since 2014.
            </p>
            <div className="space-y-3">
              ...
              <a href="tel:+923334023007" className="flex items-center gap-3 text-sm text-gray-400 hover:text-gold transition-colors">
                <Phone className="w-5 h-5 text-gold flex-shrink-0" />
                <span>+92 333 4023007</span>
              </a>
              <a href="mailto:info@maanestate.com" className="flex items-center gap-3 text-sm text-gray-400 hover:text-gold transition-colors">
                <Mail className="w-5 h-5 text-gold flex-shrink-0" />
                <span>info@maanestate.com</span>
              </a>
            </div>
          </div>
          ...
          {/* Services */}
          <div>
            <h4 className="font-display text-lg uppercase tracking-wider mb-6">Our Services</h4>
            <ul className="space-y-3">
          ...
          {/* DHA Locations */}
          <div>
            <h4 className="font-display text-lg uppercase tracking-wider mb-6">Dealing In</h4>
            <ul className="space-y-3">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <p className="text-gray-500 text-sm text-center md:text-left">
              &copy; {new Date().getFullYear()} MAAN Estate. All rights reserved.
            </p>
