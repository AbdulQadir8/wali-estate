...
const values = [
  ...
  },
  {
    icon: Users,
    title: 'Client First',
    description: 'Our clients needs are at the center of everything we do. Your success is our success.',
  },
  {
    icon: TrendingUp,
    title: 'Innovation',
    description: 'We embrace technology and innovative solutions to provide better real estate services.',
  },
];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <p 
              ...
              `}
            >
              Since 2014, MAAN Estate has been the leading name in Lahore real estate and 
              Dubai property. Recognized as the No.1 authorized dealer in DHA, we specialize 
              in providing transparent, reliable, and timely services.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            <div>
              ...
              <p className="text-gray-600 leading-relaxed mb-6">
                At MAAN Estate, our mission is to simplify the real estate journey for our clients. 
                We aim to be the most trusted and respected real estate company in Pakistan by 
                delivering exceptional service and building lasting relationships.
              </p>
              <p className="text-gray-600 leading-relaxed mb-6">
                We believe that everyone deserves access to accurate information, professional 
                guidance, and fair deals when it comes to property transactions. Our team works 
                tirelessly to ensure that every client receives personalized attention and expert advice.
              </p>
              <div className="flex items-center gap-4 p-4 bg-gold/10 rounded-xl">
                <Award className="w-10 h-10 text-gold" />
                <div>
                  <p className="font-display font-bold text-gray-900">#1 Authorized Dealer</p>
